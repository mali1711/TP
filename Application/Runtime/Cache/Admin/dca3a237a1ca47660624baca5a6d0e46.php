        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form class="form-horizontal" role="form" action="/TP/index.php/Admin/Shop/doAddGoods" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="clearfix">
                                    <script name="bun_goods_desc" type="text/plain" id="myEditor" style="width:1000px;height:240px;"></script>
                                    <div>
                                        <h3 id="focush2"></h3>
                                    </div>
                                    <script type="text/javascript">
