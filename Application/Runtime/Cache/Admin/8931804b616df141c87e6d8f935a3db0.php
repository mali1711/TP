        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form class="form-horizontal" role="form" action="/TP/index.php/Admin/Share/updateReward" method="post" enctype="multipart/form-data">
                        ...
                        <input name="share_id" type='hidden' value="<?php echo ($list["reward_id"]); ?>" class="col-xs-10 col-sm-5" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
											<span class="input-icon">
												<input id="form-field-icon-1" value="<?php echo ($list["reward_integral"]); ?>" type="text" name="reward_integral" placeholder="积分数量">
												<i class="icon-leaf blue"></i>
											</span>

											<span class="input-icon input-icon-right">
												<input id="form-field-icon-2" type="text" value="<?php echo ($list["reward_red_packets"]); ?>" name="reward_red_packets" placeholder="红包金额">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
											<span class="input-icon">
												<input id="form-field-icon-1" type="text" value="<?php echo ($list["reward_Visit_integral"]); ?>" name="reward_Visit_integral" placeholder="积分数量">
												<i class="icon-leaf blue"></i>
											</span>

											<span class="input-icon input-icon-right">
												<input id="form-field-icon-2" type="text" value="<?php echo ($list["reward_Visit_red_packets"]); ?>" name="reward_Visit_red_packets"  placeholder="红包金额">
												<i class="icon-leaf green"></i>
											</span>
                            </div>
