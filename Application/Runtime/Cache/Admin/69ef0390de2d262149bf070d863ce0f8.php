                            ...
                            <div class="table-responsive">
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                    ...
                                    <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                                            <td class="center">
                                                <label>
                                                    <img height="50px" src="/TP/Uploads/<?php echo ($vo["share_pic"]); ?>">
                                                    <span class="lbl"></span>
                                                </label>
                                            </td>

                                            <td>
                                                <a href="/TP/index.php/Admin/Shop/updateGoods/id/<?php echo ($vo["coupons_id"]); ?>"><?php echo ($vo["share_title"]); ?></a>
                                            </td>
                                            <td><?php echo ($vo["share_content"]); ?></td>
                                            <td class="hidden-480">
                                                <span class="label label-sm label-warning"><?php echo ($vo["share_overtime"]); ?></span>
                                            </td>
                                            ...
                                            <td>
                                                <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                    ...
                                                    <button class="btn btn-xs btn-danger" title="删除">
                                                        <a style="text-decoration:none; color: #ffffff;" href="/TP/index.php/Admin/share/delShare/id/<?php echo ($vo["share_id"]); ?>"><i class="icon-trash bigger-120"></i></a>
                                                    </button>

                                                    <button class="btn btn-xs btn-success" title="查看奖励">
                                                        <a style="text-decoration:none; color: #ffffff;" href="/TP/index.php/Admin/share/addReward/id/<?php echo ($vo["share_id"]); ?>"><i class="icon-ok bigger-120"></i></a>
                                                    </button>
