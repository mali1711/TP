                        ...
                        <div class="col-xs-12">
                            <div class="table-responsive">
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                    ...
                                    <?php if(is_array($goodlist)): foreach($goodlist as $key=>$vo): ?><tr>
                                        <td class="center">
                                            <label>
                                                <input type="checkbox" class="ace" />
                                                <span class="lbl"></span>
                                        ...
                                        <td>
                                            <a href="/TP/index.php/Admin/Shop/updateGoods/id/<?php echo ($vo["bun_goods_id"]); ?>"><?php echo ($vo["bun_goods_name"]); ?></a>
                                        </td>
                                        <td><?php echo ($vo["bun_goods_price"]); ?></td>
                                        <td class="hidden-480"><?php echo ($vo["bun_goods_num"]); ?></td>
                                        <td><img height="50px" src="/TP/Uploads/<?php echo ($vo["bun_goods_pic"]); ?>"></td>

                                        <td class="hidden-480">
                                            <span class="label label-sm label-warning">上架</span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                ...
                                                <button class="btn btn-xs btn-danger" title="删除">
                                                    <a style="text-decoration:none; color: #ffffff;" href="/TP/index.php/Admin/Shop/delGoods/id/<?php echo ($vo["bun_goods_id"]); ?>"><i class="icon-trash bigger-120"></i></a>
                                                </button>

                                                <button class="btn btn-xs btn-success" title="详情">
                                                    <a style="text-decoration:none; color: #ffffff;" href="/TP/index.php/Admin/Shop/delGoods/id/<?php echo ($vo["bun_goods_id"]); ?>"><i class="icon-ok bigger-120"></i></a>
                                                </button>
