        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form class="form-horizontal" role="form" action="/TP/index.php/Admin/Share/doAddShare" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 优惠券图片： </label>

                            <div class="col-sm-9">
                                <input type="file" id="id-input-file-2"  name="share_pic" class="col-xs-10 col-sm-5" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 优惠券标题： </label>

                            <div class="col-sm-9">
                                <input type="text" id="form-field-1" name="share_title" placeholder="标题" class="col-xs-10 col-sm-5" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-5">简介：</label>

                            <div class="col-sm-9">
                                <div class="clearfix">
                                    <textarea class="col-xs-5" rows="5" type="text" name="share_content" id="form-field-5" placeholder="" ></textarea>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="clearfix">
                                    <input name="share_overtime" value="1" class="ace ace-switch ace-switch-7" type="datetime-local">
                                    <span class="lbl"></span>
                                </div>
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-5">详情：</label>

                            <div class="col-sm-9">
                                <div class="clearfix">
                                    <script name="share_desc" type="text/plain" id="myEditor" style="width:500px;height:240px;"></script>
                                    <div>
                                        <h3 id="focush2"></h3>
                                    </div>
                                    <script type="text/javascript">
