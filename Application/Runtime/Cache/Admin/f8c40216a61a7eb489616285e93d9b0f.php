                            ...
                            <div class="table-responsive">
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th>优惠券名称</th>
                                        <th>剩余数量</th>
                                        <th class="hidden-480">满足条件以及优惠</th>
                                    ...
                                    <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                                        ...
                                        <td>
                                            <a href="/TP/index.php/Admin/Shop/updateGoods/id/<?php echo ($vo["coupons_id"]); ?>"><?php echo ($vo["coupons_name"]); ?></a>
                                        </td>
                                        <td><?php echo ($vo["coupons_num"]); ?></td>
                                        <td class="hidden-480">满<?php echo ($vo["coupons_satisfy"]); ?>减<?php echo ($vo["coupons_money"]); ?></td>
                                        <td><img height="50px" src="/TP/Uploads/<?php echo ($vo["coupons_image"]); ?>"></td>

                                        <td class="hidden-480">
                                            <span class="label label-sm label-warning"><?php echo ($vo["coupons_overtime"]); ?></span>
                                        </td>
...
<!--
                                                <button class="btn btn-xs btn-info" title="修改">
                                                    <a style="text-decoration:none; color: #ffffff;" href="/TP/index.php/Admin/Shop/update/id/<?php echo ($vo["bun_goods_id"]); ?>"><i class="icon-edit bigger-120"></i></a>
                                                </button>-->

                                                <button class="btn btn-xs btn-danger" title="删除">
                                                    <a style="text-decoration:none; color: #ffffff;" href="/TP/index.php/Admin/Coupons/delCoupons/id/<?php echo ($vo["coupons_id"]); ?>"><i class="icon-trash bigger-120"></i></a>
                                                </button>

                                                <button class="btn btn-xs btn-success" title="修改">
                                                    <a style="text-decoration:none; color: #ffffff;" href="/TP/index.php/Admin/Coupons/updateCoupons/id/<?php echo ($vo["coupons_id"]); ?>"><i class="icon-ok bigger-120"></i></a>
                                                </button>
