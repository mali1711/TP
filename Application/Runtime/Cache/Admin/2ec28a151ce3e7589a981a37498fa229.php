        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form class="form-horizontal" role="form" action="/TP/index.php/Admin/Shop/doUpdateGoods" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="bun_goods_id" value="<?php echo ($info["bun_goods_id"]); ?>"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="form-field-1" name="bun_goods_name" value="<?php echo ($info["bun_goods_name"]); ?>" placeholder="商品名" class="col-xs-10 col-sm-5" />
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="clearfix">
                                    <input class="col-xs-1" type="text" name="bun_goods_num" value="<?php echo ($info["bun_goods_num"]); ?>" id="form-field-5" placeholder="" />
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="clearfix">
                                    <input class="col-xs-1" type="text" name="bun_goods_price" value="<?php echo ($info["bun_goods_price"]); ?>" id="form-field-5" placeholder="" />
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="clearfix">
                                    <script name="bun_goods_desc" type="text/plain" id="myEditor" style="width:1000px;height:240px;"><?php echo ($info["bun_goods_desc"]); ?></script>
                                    <div>
                                        <h3 id="focush2"></h3>
                                    </div>
                                    <script type="text/javascript">
