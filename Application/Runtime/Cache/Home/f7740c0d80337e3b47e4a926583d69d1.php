                            ...
                            <div class="table-responsive">
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                    ...
                                    <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                                            ...
                                            <td class="hidden-480"><?php echo ($vo["users_phone"]); ?></td>
                                            ...
                                            <td>
                                                <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                    <button class="btn btn-xs btn-success">
                                                        <a style="text-decoration:none;out-line: none;color:white;" href="/TP/index.php/Home/Users/getUserInfo/id/<?php echo ($vo["users_id"]); ?>"><i class="icon-ok bigger-120" title="查看用户详情"></i></a>
                                                    </button>

                                                    <button class="btn btn-xs btn-info">
                                                        <i class="icon-edit bigger-120" title="修改用户"></i>
                                                    </button>
                                                    ...
                                                    <button class="btn btn-xs btn-warning">
                                                        <i class="icon-flag bigger-120" title="查看详情"></i>
                                                    </button>
                                                </div>
