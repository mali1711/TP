                            ...
                            <div class="table-responsive">
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                    ...
                                    <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                                            ...
                                            <td><?php echo ($vo["business_account"]); ?></td>
                                            <td class="hidden-480"><?php echo ($vo["business_name"]); ?></td>
                                            <td><?php echo ($vo["business_phone"]); ?></td>
                                            ...
                                            <td>
                                                <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                    <button class="btn btn-xs btn-success">
                                                        <a style="text-decoration:none;out-line: none;color:white;" href="/TP/index.php/Home/Business/getBusinessDetailInfo/id/<?php echo ($vo["business_id"]); ?>"><i class="icon-ok bigger-120" title="详情"></i></a>
                                                    </button>
                                                    ...
                                                    <button class="btn btn-xs btn-danger">
                                                        <i class="icon-trash bigger-120" title="禁用" ></i>
                                                    </button>

                                                    <button class="btn btn-xs btn-warning">
                                                        <i class="icon-flag bigger-120" title="其他操作"></i>
                                                    </button>
                                                </div>
