...
<form  action="/TP/index.php/Users/Users/dologin" method="post">
    <div id="top">
        ...
        <div id="num"><b>电话 </b><input type="text" name="users_phone" style="width:74%;height:92px;font-size:30px;border:0px"/><span>未填写&nbsp;></span></div>
        <div id="num"><b>密码</b><input type="password" name="users_pass" style="width:74%;height:92px;font-size:30px;border:0px"/><span>未填写&nbsp;></span></div>
        <div id="foot">
