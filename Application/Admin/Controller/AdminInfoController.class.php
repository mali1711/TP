...
class AdminInfoController extends Controller {
    ...
    public function index()
    {
        ...
        $info = $business->find($business_id);
        $timeData = $this->__getTime();
        $timeEnd = $timeData['timeEnd'];
        $timeStart = $timeData['timeStart'];
        $businessInfo['info'] = $info;
        $businessInfo['b_turnover_in_the_day'] = $b_turnover_in_the_day->where("b_turnover_in_the_day_time <= $timeEnd and b_turnover_in_the_day_time > $timeStart and business_id = $business_id")->find();
        $businessInfo['b_turnover_in_the_day']['b_turnover_in_the_day_integral_new'] = floatval($businessInfo['b_turnover_in_the_day']['b_turnover_in_the_day_integral_new']);
        $businessInfo['b_turnover_in_the_day']['b_turnover_in_the_day_integral_ord'] = floatval($businessInfo['b_turnover_in_the_day']['b_turnover_in_the_day_integral_ord']);
        $businessInfo['SpendList'] =$this->__getUserSpendList($business_id);//获取用户消费的详情列表
        $businessInfo['userCount'] = count($this->__getUserSpendList($business_id));//获取用户消费的详情列表
...
//            echo $business->getLastSql();
    ...
    public function getUserIntegral()
    {
        ...
        $timeEnd = $timeData['timeEnd'];
        $timeStart = $timeData['timeStart'];
        $business_id = $_SESSION['Admin']['business_id'];//商家id todo
        $list = $users_integral_list->where("users_integral_addtime <= $timeEnd and users_integral_addtime > $timeStart and business_id=$business_id" )->select();
        $array = array();
        foreach($list as $k=>$v){
    ...
    public function userProportion()
    {
        $users_integral_list = M('users_integral_list');
        $b_turnover_in_the_day = M('b_turnover_in_the_day');
        $business_id = $_SESSION['Admin']['business_id'];//todo
